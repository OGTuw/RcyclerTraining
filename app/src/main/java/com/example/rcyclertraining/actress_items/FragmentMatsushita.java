...
public class FragmentMatsushita extends Fragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_matsushita, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(getContext()).load(R.drawable.matsushita).into(img);
    }
}
